        ...
        (orient [-90 0 0]
          (difference
           (union
            ...
            (cylinder extra (* 2 plug-outer-radius) (* 2 plug-outer-radius) 0
                      :cs [0 0 (+ (- (/ plug-height 2)) (/ extra 4))]))
           (cylinder (+ plug-height 24) plug-inner-radius plug-inner-radius)
           (orient [-90 0 0]
             (cube (* 2 plug-attached-nub-extent) plug-attached-nub-width
                   (+ 20 plug-height)
                   :cs [(- plug-inner-radius) 0 0])
             (cube (* 2 plug-attached-nub-extent) plug-top-nub-width
                   (+ 21 plug-height)
                   :cs [plug-inner-radius 0 0])
